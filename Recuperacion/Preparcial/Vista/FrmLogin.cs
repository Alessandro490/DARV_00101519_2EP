...
namespace Preparcial
{
    public partial class FrmLogin : Form
    {
        ...
        {
            //El primer error encontrado es la contrasena, pues aunque se ponga correcta nos muestra un mensaje de error
            //El error se debe a que se esta llamando a la variable contrasenia del evento Usuario el cual es incorrecto, pues es contrasena la variable correcta
